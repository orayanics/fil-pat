...
export default function SeedTemplates20Page() {
  ...
  const handleSeed = async () => {
    ...
    try {
      const response = await fetch('/api/templates/seed-20', {
        method: 'POST',
        ...
        >
          <Box>
            <Typography level="h2" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <CloudUploadIcon /> Seed 20-Item Templates
            </Typography>
            <Chip
        ...
        <Card variant="outlined" sx={{ mb: 3 }}>
          <CardContent>
            <Typography level="h4" sx={{ mb: 2 }}>
              Simplified 20-Item Assessment Templates
            </Typography>

            <Typography level="body-md" sx={{ mb: 2, color: 'neutral.600' }}>
              This will create two simplified 20-item assessment templates for your account:
            </Typography>

            <Box component="ul" sx={{ pl: 3, mb: 3 }}>
              <li>
                <Typography level="body-md">
                  <strong>Filipino PAT - Kids Edition (20 Items)</strong>
                  <br />
                  <Typography level="body-sm" sx={{ color: 'neutral.600' }}>
                    Child-friendly assessment with playful images and simple vocabulary. Ideal for ages 3-7.
                  </Typography>
                </Typography>
              </li>
              <li style={{ marginTop: '12px' }}>
                <Typography level="body-md">
                  <strong>Filipino PAT - Standard Assessment (20 Items)</strong>
                  <br />
                  <Typography level="body-sm" sx={{ color: 'neutral.600' }}>
                    Simplified assessment covering a range of phonemes and difficulty levels.
                  </Typography>
                </Typography>
              </li>
            </Box>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
              {success ? (
                ...
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? 'Seeding 20-Item Templates...' : 'Seed 20-Item Templates'}
                </Button>
              )}
            </Box>
          </CardContent>
