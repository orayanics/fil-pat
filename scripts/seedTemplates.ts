...
async function main() {
  ...
  // Insert all 76 items
  console.log('   Adding 76 assessment items...');
  ...
  console.log('   ✅ Added all 76 items');

  // Create Kids Template (same 76 items but marked for kids)
  console.log('');
  ...
  console.log('');
  console.log('📊 Summary:');
  console.log(`   • Standard Template: ID ${standardTemplate.template_id} (76 items)`);
  console.log(`   • Kids Template: ID ${kidsTemplate.template_id} (76 items)`);
  console.log(`   • Owner: ${targetClinician.first_name} ${targetClinician.last_name}`);
  console.log(`   • Total Items Created: 152 items`);
  console.log('═══════════════════════════════════════════════════════');
}
